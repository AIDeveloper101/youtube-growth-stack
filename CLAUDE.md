# YouTube Growth Stack — Claude Rulebook

> Primary agent instructions for Claude Code. A Codex-compatible mirror lives in
> `AGENTS.md` — keep the two in sync when rules change.

> **Next.js warning:** this repo uses a Next.js version with breaking changes —
...
Reusable recipes live in `.claude/skills/<name>/SKILL.md`. Before implementing
a task that matches a skill, read and follow it:
